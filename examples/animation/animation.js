...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_bf73756fffc44ed816ed3a187fe6fa9384078727": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){var callback = ($1); function loop (time){value.id = requestAnimationFrame (loop); callback (time);}var value = {callback : callback , id : requestAnimationFrame (loop)}; return value ;})());
            },
            "__extjs_39d6f878cbbcf3388749d869474d9b337f20e0b4": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);var self = ($0); cancelAnimationFrame (self.id); self.callback.drop ();
            },
            ...
            "__extjs_bf9e6431a921831f75889f3c3a59bde556a642e6": function($0, $1, $2) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);($0). style.setProperty (($1), ($2), "");
            },
            ...
            "__extjs_2ba615754f43a58234da5f7bebfdf17f7985f4b8": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){console.log ("Dropping");})());
            },
            "__extjs_4b1c8bef54b5be5d875e47b3fdb36644856937ca": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return setInterval (function (){($1)();}, 500);})());
            },
            ...
            "__extjs_e175b396836d427332bb72f3afbf9de6cb563afa": function($0, $1, $2) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);($0). style.setProperty (($1), ($2), "important");
            },
    ...
    if( __load_asynchronously ) {
        return WebAssembly.instantiate( __wasm_module, __imports )
            .then( instance => {
                ...
                console.log( "Finished loading Rust wasm module 'animation'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'animation':", error );
                throw error;
            });
    } else {
    ...
    if( typeof window === "undefined" && typeof process === "object" ) {
        ...
        const wasm_path = path.join( __dirname, "animation.wasm" );
        const buffer = fs.readFileSync( wasm_path );
        const mod = new WebAssembly.Module( buffer );

        return __initialize( mod, false );
    } else {
        return fetch( "animation.wasm" )
