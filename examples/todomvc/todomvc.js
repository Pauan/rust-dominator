...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    const __imports = {
        env: {
            "__extjs_bfdffb160a8afe051d5bd1525479df8ce544e218": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);($0). callback.drop ();
            },
            ...
            "__extjs_4c55528c1479bf21e3e0cc48a3b28ee15f080fdf": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);($0). next_tick ();
            },
            ...
            "__extjs_f0a27fb46258ec6178aa2160254a02a6493514c8": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). hash ;})());
            },
            ...
            "__extjs_9e2f40262b47a456e78f7a6cdebd5e5ba42abc37": function($0, $1) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);var element = ($0); if (($1)){element.focus ();}else {element.blur ();}
            },
            ...
            "__extjs_86e66e640f55d9e76205a200b5eab781c9ebe681": function($0, $1, $2) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);($0). classList.toggle (($1), ($2));
            },
            ...
            "__extjs_3a9654ebc7f4529fb5dc86a17c9eb48ebed27453": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){var callback = ($1); if (typeof MutationObserver ==="function"){var node = document.createTextNode ("0"); var state = false ; new MutationObserver (function (changes , observer){callback ();}). observe (node , {characterData : true}); return {callback : callback , next_tick : function (){state = ! state ; node.data = (state ? "1" : "0");}};}else {var promise = Promise.resolve (null); function next_tick (value){callback ();}return {callback : callback , next_tick : function (){promise.then (next_tick);}};}})());
            },
            ...
            "__extjs_5128438ca0af1ed0baabdd0e3c3c364659354466": function($0) {
                return (Module.STDWEB_PRIVATE.acquire_js_reference( $0 ) instanceof Text) | 0;
            },
            ...
            "__extjs_15f26ee992a31cb57ffcfb937eaf8bcb84c718dc": function($0) {
            ...
            "__extjs_e6a5e742c398018c127595f0ffa4f449a1581320": function($0, $1) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);var parent = ($0); parent.removeChild (parent.childNodes [($1)]);
            },
            "__extjs_cd167021a7bb085ca183bf0c9dde5277b9f77aca": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);($0). innerHTML = "" ;
            },
            "__extjs_1c1e01afcd486d3cd3159bb64e14ae0bfb5b12fc": function($0, $1, $2) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);var parent = ($0); parent.replaceChild (($1), parent.childNodes [($2)]);
            },
            "__extjs_3dbc1852e0a40fec79a39321d80f68e700cf06e2": function($0, $1, $2) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);var parent = ($0); parent.insertBefore (($1), parent.childNodes [($2)]);
            },
